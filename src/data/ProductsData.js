...
export const products = [
  {
    ...
    oldPrice: 82,
    details:
      "نص افتراضي يعرض مواصفات المنتج الذي سيتم عرضه في هذه الصفحة، يحاكي هذا النص صفحة المعلومات التي يحتاجها الزبون حول المنتج المطلوب ويحدد نقاط القوة للمنتج والتي تعطي حافز للزبون على الشراء، لا يوجد نص ثابت هنا ويعتمد هذا على المنتج المعروض.",
  },
  {
    id: 2,
    image: <Product2Img />,
